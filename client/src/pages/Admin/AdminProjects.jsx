          ...
          <div className="shadow border border-gray-400 gap-5 p-5 flex flex-col justify-between">
            <div className="justify-evenly ">
              ...
              <p className="pb-2 pt-4 image">
                <img src={project.image} alt="" className="h-60 " />
              </p>
              <p className="pb-2 pt-2 title">
                <b>Role:</b> {project.title}
              </p>
              <p className="pb-2 pt-2 technologies">{project.technologies}</p>

              <p className="pb-2 pt-2 description">{project.description}</p>
            </div>
